...
const mapDataSchema = {
  ...
  properties: {
    tasks: { type: "array", items: { type: "object", additionalProperties: false, required: ["id", "title", "category", "date", "time", "endDate", "carriedFrom", "priority", "status"], properties: { id: { type: "string" }, title: { type: "string" }, category: { enum: ["学业", "求职", "生活", "健康"] }, date: { type: "string" }, time: { type: ["string", "null"] }, endDate: { type: ["string", "null"] }, carriedFrom: { type: ["string", "null"] }, priority: { enum: ["high", "normal"] }, status: { enum: ["todo", "done"] } } } },
