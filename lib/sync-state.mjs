const COLLECTION_KEYS = ["tasks", "routines", "schedule", "goals", "habits", "workouts", "applications", "notes"];
...
export function toSyncPayload(data) {
  return Object.fromEntries([
    ...
    ...COLLECTION_KEYS.map((key) => [key, structuredClone(Array.isArray(data[key]) ? data[key] : [])]),
  ]);
}
