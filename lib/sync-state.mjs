const COLLECTION_KEYS = ["tasks", "routines", "schedule", "goals", "habits", "workouts", "trainingPlans", "exercises", "exerciseLogs", "activityLogs", "mealThemes", "mealPlans", "mealRecipes", "applications", "notes", "references"];
const SINGLETON_KEYS = ["phase", "habitDate", "workoutWeek"];
